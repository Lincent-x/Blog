...
<header class="site-header">
    <div class="container">
        <h1><a href="/">xw-liang Blog</a></h1>
        <nav class="site-header-nav" role="navigation">

            <a href="/" class=" site-header-nav-item" target="" title="Home"></a>
...
<footer class="container">
    <div class="site-footer" role="contentinfo">
        <div class="copyright left mobile-block">
            Copyright  © 2015
            <span >aceclound.cn. All Rights Reserved. 携传 版权所有</span>
        ...
        <a href="https://github.com/XiaoweiTy/" target="_blank" aria-label="view source code">
